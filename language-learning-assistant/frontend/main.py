...
def render_header():
    ...
    - DeepSeek-R1 chat through the SambaNova API
    - YouTube transcript and media processing
    - Cloud transcription workflow
    - Dialogue extraction and vocabulary analysis
    """)
    ...
    if transcript_text:
        ...
        with col2:
            ...
            process_option = st.selectbox(
                "Processing Type",
                ["Extract Dialogues", "Identify Vocabulary"]
            )
